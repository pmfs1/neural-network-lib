...
def BIRCH(X: np.ndarray, BRANCHING_FACTOR: int, THRESHOLD: float = 0.5) -> np.ndarray:
    ...
    def __INSERT__(POINT: np.ndarray, NODE: BIRCH_NODE) -> BIRCH_NODE | None:
        ...
        if NODE.IS_LEAF:  # IF THE CURRENT NODE IS A LEAF NODE, UPDATE ITS SUBCLUSTER CENTERS AND SAMPLE COUNT.
            ...
            # ASSERT THAT THE CLOSEST CHILD NODE IS NOT NONE.
            assert CLOSEST_CHILD is not None
    ...
    def __FIND_CLOSEST_CLUSTER__(POINT: np.ndarray, NODE: BIRCH_NODE) -> BIRCH_NODE:
        ...
        if NODE.IS_LEAF:  # IF THE NODE IS A LEAF NODE:
            ...
            # ASSERT THAT THE CLOSEST CLUSTER IS NOT NONE.
        ...
        # ASSERT THAT THE CLOSEST CHILD IS NOT NONE.
        assert CLOSEST_CHILD is not None
