...
def BIRCH(X: np.ndarray, BRANCHING_FACTOR: int, THRESHOLD: float = 0.5) -> np.ndarray:
    ...
    class BIRCH_NODE:
        ...
        def ADD_CHILD(self, CHILD: 'BIRCH_NODE') -> None:
        ...
        def UPDATE_SUBCLUSTER_CENTERS(self, POINT: np.ndarray) -> None:
        ...
        def COMPUTE_PROTOTYPE(self) -> None:
    ...
    def __INSERT__(POINT: np.ndarray, NODE: BIRCH_NODE) -> BIRCH_NODE|None:
        ...
        if NODE.IS_LEAF:  # IF THE CURRENT NODE IS A LEAF NODE, UPDATE ITS SUBCLUSTER CENTERS AND SAMPLE COUNT.
            ...
            assert CLOSEST_CHILD is not None  # ASSERT THAT THE CLOSEST CHILD NODE IS NOT NONE.
    ...
    def __SPLIT_NODE__(NODE: BIRCH_NODE) -> None:
    ...
    def __FIND_CLOSEST_CLUSTER__(POINT: np.ndarray, NODE: BIRCH_NODE) -> BIRCH_NODE:
        ...
        if NODE.IS_LEAF:  # IF THE NODE IS A LEAF NODE:
            ...
            assert CLOSEST_CLUSTER is not None  # ASSERT THAT THE CLOSEST CLUSTER IS NOT NONE.
        ...
        assert CLOSEST_CHILD is not None  # ASSERT THAT THE CLOSEST CHILD IS NOT NONE.
