...
# K_MEANS_CLUSTERING: CLASS THAT IMPLEMENTS K MEANS CLUSTERING MODEL
class K_MEANS_CLUSTERING:
    ...
    # TODO: CHANGE EUCLIDEAN_DISTANCE() TO DISTANCE_BETWEEN_POINTS() WHICH IS THE ONE THAT IS USED IN THIS ALGORITHM.
