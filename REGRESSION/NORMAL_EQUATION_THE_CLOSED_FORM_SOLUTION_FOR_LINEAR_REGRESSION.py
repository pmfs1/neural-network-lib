...
class NORMAL_EQUATION_THE_CLOSED_FORM_SOLUTION_FOR_LINEAR_REGRESSION:
    ...
    def FIND_THETA(self, X, Y):
        ...
        X = np.append(X, np.ones((NUMBER_OF_SAMPLES, 1)), axis=1) # APPENDING A COLUMN OF ONES IN X TO ADD THE BIAS TERM.
    ...
    # TRANSFORM(X): RETURNS THE PREDICTIONS OF THE LINEAR REGRESSION MODEL FOR THE INPUT DATA X.
