...
class LOGISTIC_REGRESSION:
    ...
    [STATIC] SIGMOID(X): CALCULATES THE SIGMOID FUNCTION.
    [STATIC] BINARY_CROSS_ENTROPY(TRUE_TARGET_VALUE, PREDICTION): CALCULATES THE BINARY CROSS ENTROPY LOSS FUNCTION.
    """
    ...
    @staticmethod
    def SIGMOID(Z):
        """[STATIC] SIGMOID ACTIVATION FUNCTION
    ...
    def BINARY_CROSSENTROPY(ACTUAL, PREDICTED):
        """[STATIC] RETURN BINARY CROSS ENTROPY.
