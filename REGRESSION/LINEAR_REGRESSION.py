...
class LINEAR_REGRESSION():
    ...
    def FIT(self, X, Y):
        ...
        for _ in range(self.EPOCHS): # FOR EACH ITERATION
            PREDICTIONS = self.TRANSFORM(X) # CALCULATES THE PREDICTIONS OF THE LINEAR REGRESSION MODEL
    ...
    # TRANSFORM(): RETURNS THE PREDICTIONS OF THE LINEAR REGRESSION MODEL
