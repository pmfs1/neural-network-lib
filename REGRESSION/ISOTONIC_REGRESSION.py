...
class ISOTONIC_REGRESSION:
    ...
    METHODS
    -------
    FIT(X, Y): FITS THE ISOTONIC REGRESSION MODEL TO THE TRAINING DATA.
    PREDICT(X): RETURNS THE PREDICTIONS OF THE ISOTONIC REGRESSION MODEL FOR THE INPUT DATA X.
    """
