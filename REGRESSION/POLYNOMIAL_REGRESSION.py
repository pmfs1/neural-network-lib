...
class POLYNOMIAL_REGRESSION:
    ...
    __LOSS_FUNCTION__(TRUE_TARGET_VALUE, PREDICTION)
        RETURNS THE LOSS VALUE.
    __GRADIENT__(X, Y, PREDICTION)
        RETURNS THE GRADIENT OF THE LOSS FUNCTION W.R.T. THE PARAMETERS: WEIGHTS AND BIAS.
    __X_PREDICT__(X, DEGREES)
