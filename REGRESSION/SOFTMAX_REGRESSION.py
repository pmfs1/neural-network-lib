...
class SOFTMAX_REGRESSION:
    ...
    def FIT(self, X, Y):
        ...
        for _ in range(self.EPOCHS): # LOOPING THROUGH THE EPOCHS
            ...
            W_GRADIENT = (1 / NUMBER_OF_SAMPLES) * np.dot(X.T, (HYPOTHESIS - Y_HOT)) # CALCULATING THE GRADIENT OF THE LOSS W.R.T WEIGHTS
            B_GRADIENT = (1 / NUMBER_OF_SAMPLES) * np.sum(HYPOTHESIS - Y_HOT) # CALCULATING THE GRADIENT OF THE LOSS W.R.T BIAS
