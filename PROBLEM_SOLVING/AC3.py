...
def AC3(CSP_PROBLEM: CSP) -> bool:
    """IMPLEMENTS THE AC-3 ALGORITHM, WHICH REDUCES THE DOMAIN OF VARIABLES IN A CONSTRAINT SATISFACTION PROBLEM (CSP) BY REMOVING VALUES THAT VIOLATE THE PROBLEM'S CONSTRAINTS. IT RETURNS FALSE IF AN INCONSISTENCY IS FOUND, INDICATING A FAILURE TO FIND A SOLUTION, AND TRUE OTHERWISE."""
    ...
    def __REVISE__(X_I: str, X_J: str) -> bool:
        """THE `__REVISE__` FUNCTION IS USED IN THE AC3 ALGORITHM TO REVISE THE DOMAINS OF A VARIABLE BASED ON THE CONSTRAINTS WITH ANOTHER VARIABLE. IT REMOVES VALUES FROM THE DOMAIN OF THE VARIABLE THAT DO NOT SATISFY THE CONSTRAINTS, AND RETURNS TRUE IF ANY REVISIONS ARE MADE, AND FALSE OTHERWISE."""
