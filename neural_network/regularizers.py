...
class ELASTIC_NET(REGULARIZER):
    ...
    def __PENALTY__(self, WEIGHTS):
        ...
        return 0.5 * self.C * WEIGHTS ** 2 + (1.0 - self.C) * np.abs(WEIGHTS) # RETURN THE SUM OF THE PRODUCT OF HALF THE REGULARIZATION STRENGTH AND THE SQUARE OF THE WEIGHTS AND THE PRODUCT OF ONE MINUS THE REGULARIZATION STRENGTH AND THE ABSOLUTE VALUE OF THE WEIGHTS