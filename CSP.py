# CSP: IMPLEMENTS A REPRESENTATION OF A CONSTRAINT SATISFACTION PROBLEM. THE CSP IS DEFINED BY ITS VARIABLES, DOMAINS, NEIGHBORS, CONSTRAINTS. IN A CSP, THE GOAL IS TO FIND AN ASSIGNMENT OF VALUES TO THE VARIABLES THAT SATISFIES ALL OF THE CONSTRAINTS.
class CSP:
