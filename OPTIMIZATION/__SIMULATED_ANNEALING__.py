...
def SIMULATED_ANNEALING(CSP_PROBLEM: CSP):
    ...
    for VARIABLE in CSP_PROBLEM.VARIABLES:
        CURRENT_STATE[VARIABLE] = np.random.choice(CSP_PROBLEM.DOMAINS[VARIABLE])
    ...
    while TEMPERATURE > 1:
        ...
        NEXT_STATE = {}
        for VARIABLE in CSP_PROBLEM.VARIABLES:
            NEXT_STATE[VARIABLE] = np.random.choice(CSP_PROBLEM.DOMAINS[VARIABLE])
        ...
        # OTHERWISE, IF THE NEXT STATE IS NOT BETTER THAN THE CURRENT STATE, THEN THE NEXT STATE BECOMES THE CURRENT STATE WITH A PROBABILITY THAT DEPENDS ON THE TEMPERATURE.
            ...
            PROBABILITY = math.exp(- (__COST_FUNCTION__(CSP_PROBLEM, NEXT_STATE) - __COST_FUNCTION__(CSP_PROBLEM, CURRENT_STATE)) / TEMPERATURE)
