...
def __INITIAL_STATE__(CSP: CSP):
    ...
    for VARIABLE in CSP.VARIABLES:
        ...
        INITIAL_STATE[VARIABLE] = CSP.DOMAINS[VARIABLE][0]
...
def __SOLUTION__(STATE, CSP: CSP):
    ...
    for VARIABLE in CSP.VARIABLES:
        ...
        for VALUE in CSP.DOMAINS[VARIABLE]:
            ...
            if VALUE != STATE[VARIABLE]:
                ...
                for VARIABLE_2 in CSP.VARIABLES:
...
def __BETTER__(SUCCESSOR, BEST_SUCCESSOR, CSP: CSP):
    # IF THERE IS NO BEST SUCCESSOR, THEN RETURN TRUE.
    if BEST_SUCCESSOR == False:
    ...
    if not __CONSISTENT__(BEST_SUCCESSOR, CSP):
    ...
    if __NUMBER_OF_VIOLATIONS__(SUCCESSOR, CSP) < __NUMBER_OF_VIOLATIONS__(BEST_SUCCESSOR, CSP):
        return True # THE NUMBER OF VIOLATIONS OF THE SUCCESSOR IS LESS THAN THE NUMBER OF VIOLATIONS OF THE BEST SUCCESSOR.
    # RETURN FALSE.
    return False

# __NUMBER_OF_VIOLATIONS__() [PRIVATE FUNCTION]: RETURNS THE NUMBER OF VIOLATIONS OF THE STATE.
def __NUMBER_OF_VIOLATIONS__(STATE, CSP: CSP):
