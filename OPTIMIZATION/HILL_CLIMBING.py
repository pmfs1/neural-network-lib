...
def HILL_CLIMBING(CSP_PROBLEM: CSP) -> dict | bool:
    ...
    # `__INITIAL_STATE__()`: THIS FUNCTION TAKES A `CSP_PROBLEM` OBJECT AS INPUT, WHICH REPRESENTS THE CONSTRAINT SATISFACTION PROBLEM.
    ...
    # `__SOLUTION__(STATE)`: THIS FUNCTION TAKES TWO PARAMETERS: `STATE`, WHICH REPRESENTS A STATE (ASSIGNMENT OF VALUES TO VARIABLES), AND `CSP_PROBLEM`, WHICH IS THE CSP PROBLEM TO BE SOLVED.
    ...
    # `__BEST_SUCCESSOR__(STATE)`: THIS FUNCTION TAKES TWO PARAMETERS: `STATE`, WHICH REPRESENTS THE CURRENT STATE, AND `CSP_PROBLEM`, WHICH IS THE CSP PROBLEM BEING SOLVED.
    ...
    # `__SUCCESSORS__(STATE)`: THIS FUNCTION TAKES TWO PARAMETERS: `STATE`, WHICH REPRESENTS THE CURRENT STATE, AND `CSP_PROBLEM`, WHICH IS THE CSP PROBLEM BEING SOLVED.
    ...
    # `__CONSISTENT__(SUCCESSOR)`: THIS FUNCTION TAKES TWO PARAMETERS: `SUCCESSOR`, WHICH REPRESENTS A SUCCESSOR STATE (AN ASSIGNMENT OF VALUES TO VARIABLES), AND `CSP_PROBLEM`, WHICH IS THE CSP PROBLEM BEING SOLVED.
    ...
    # `__BETTER__(SUCCESSOR, BEST_SUCCESSOR)`: THIS FUNCTION TAKES THREE PARAMETERS: `SUCCESSOR`, WHICH REPRESENTS A SUCCESSOR STATE, `BEST_SUCCESSOR`, WHICH REPRESENTS THE CURRENT BEST SUCCESSOR STATE, AND `CSP_PROBLEM`, WHICH IS THE CSP PROBLEM BEING SOLVED.
    ...
    # `__NUMBER_OF_VIOLATIONS__(STATE)`: THIS FUNCTION TAKES TWO PARAMETERS: `STATE`, WHICH REPRESENTS A STATE (AN ASSIGNMENT OF VALUES TO VARIABLES), AND `CSP_PROBLEM`, WHICH IS THE CSP PROBLEM BEING SOLVED.
