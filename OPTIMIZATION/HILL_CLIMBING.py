...
def HILL_CLIMBING(CSP_PROBLEM: CSP) -> dict | bool:
    ...
    CURRENT_STATE = __INITIAL_STATE__(
        CSP_PROBLEM)  # INITIALIZE THE CURRENT STATE
...
# `__INITIAL_STATE__(CSP_PROBLEM: CSP)`: THIS FUNCTION TAKES A `CSP_PROBLEM` OBJECT AS INPUT, WHICH REPRESENTS THE CONSTRAINT SATISFACTION PROBLEM.
...
# `__SOLUTION__(STATE, CSP_PROBLEM: CSP)`: THIS FUNCTION TAKES TWO PARAMETERS: `STATE`, WHICH REPRESENTS A STATE (ASSIGNMENT OF VALUES TO VARIABLES), AND `CSP_PROBLEM`, WHICH IS THE CSP PROBLEM TO BE SOLVED.
...
# `__BEST_SUCCESSOR__(STATE, CSP_PROBLEM: CSP)`: THIS FUNCTION TAKES TWO PARAMETERS: `STATE`, WHICH REPRESENTS THE CURRENT STATE, AND `CSP_PROBLEM`, WHICH IS THE CSP PROBLEM BEING SOLVED.
...
def __BEST_SUCCESSOR__(STATE: dict, CSP_PROBLEM: CSP) -> dict | None:
    """THE `__BEST_SUCCESSOR__` FUNCTION IS A HELPER FUNCTION USED BY THE `HILL_CLIMBING` FUNCTION TO SELECT THE BEST SUCCESSOR STATE FROM A SET OF SUCCESSOR STATES. IT EVALUATES EACH SUCCESSOR STATE BASED ON A SET OF CRITERIA AND SELECTS THE ONE THAT IMPROVES THE CURRENT STATE THE MOST."""
...
# `__SUCCESSORS__(STATE, CSP_PROBLEM: CSP)`: THIS FUNCTION TAKES TWO PARAMETERS: `STATE`, WHICH REPRESENTS THE CURRENT STATE, AND `CSP_PROBLEM`, WHICH IS THE CSP PROBLEM BEING SOLVED.
...
# `__CONSISTENT__(SUCCESSOR, CSP_PROBLEM: CSP)`: THIS FUNCTION TAKES TWO PARAMETERS: `SUCCESSOR`, WHICH REPRESENTS A SUCCESSOR STATE (AN ASSIGNMENT OF VALUES TO VARIABLES), AND `CSP_PROBLEM`, WHICH IS THE CSP PROBLEM BEING SOLVED.
...
def __CONSISTENT__(SUCCESSOR: dict, CSP_PROBLEM: CSP) -> bool:
...
# `__BETTER__(SUCCESSOR, BEST_SUCCESSOR, CSP_PROBLEM: CSP)`: THIS FUNCTION TAKES THREE PARAMETERS: `SUCCESSOR`, WHICH REPRESENTS A SUCCESSOR STATE, `BEST_SUCCESSOR`, WHICH REPRESENTS THE CURRENT BEST SUCCESSOR STATE, AND `CSP_PROBLEM`, WHICH IS THE CSP PROBLEM BEING SOLVED.
...
def __BETTER__(SUCCESSOR: dict, BEST_SUCCESSOR: dict | None, CSP_PROBLEM: CSP) -> bool:
    ...
    if __CONSISTENT__(SUCCESSOR, CSP_PROBLEM):  # IF THE SUCCESSOR IS CONSISTENT
        return True  # RETURN TRUE TO INDICATE THAT THE SUCCESSOR IS BETTER
...
# `__NUMBER_OF_VIOLATIONS__(STATE, CSP_PROBLEM: CSP)`: THIS FUNCTION TAKES TWO PARAMETERS: `STATE`, WHICH REPRESENTS A STATE (AN ASSIGNMENT OF VALUES TO VARIABLES), AND `CSP_PROBLEM`, WHICH IS THE CSP PROBLEM BEING SOLVED.
...
def __NUMBER_OF_VIOLATIONS__(STATE: dict, CSP_PROBLEM: CSP) -> int:
    """THE `__NUMBER_OF_VIOLATIONS__` FUNCTION IS A HELPER FUNCTION USED IN THE HILL CLIMBING ALGORITHM TO COUNT THE NUMBER OF CONSTRAINT VIOLATIONS IN A GIVEN STATE. IT PROVIDES A MEASURE OF THE QUALITY OR FITNESS OF A STATE BASED ON THE NUMBER OF CONSTRAINTS THAT ARE NOT SATISFIED."""
