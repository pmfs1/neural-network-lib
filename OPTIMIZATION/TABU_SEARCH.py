...
def TABU_SEARCH(CSP: CSP):
    ...
    TABU_LIST_SIZE = len(CSP.VARIABLES)
    ...
    while True:
        ...
        CURRENT_STATE = __BEST_SUCCESSOR__(CURRENT_STATE, CSP, TABU_LIST)
...
def __BEST_SUCCESSOR__(STATE, CSP: CSP, TABU_LIST):
    ...
    for SUCCESSOR in __SUCCESSORS__(STATE, CSP):
        ...
        if SUCCESSOR not in TABU_LIST:
            ...
            elif __BETTER__(SUCCESSOR, BEST_SUCCESSOR, CSP):
                BEST_SUCCESSOR = SUCCESSOR
