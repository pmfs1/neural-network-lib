...
class PARAMETER:
    """PARAMETER CLASS FOR NEURAL NETWORKS

    THIS CLASS HOLDS THE PARAMETERS OF A LAYER IN A NEURAL NETWORK. IT ALSO
    HOLDS THE GRADIENTS OF THE PARAMETERS.
    ...
    METHODS
    -------
    SETUP_WEIGHTS(W_SHAPE, B_SHAPE=None)
        SETUP WEIGHTS OF A LAYER.
    INIT_GRAD()
        INITIALIZE GRADIENTS OF A LAYER.
    UPDATE_GRAD(PARAM, GRAD)
    ...
    PROPERTIES
    ----------
    __NUMBER_OF_PARAMETERS__
        RETURN NUMBER OF PARAMETERS.
    GRADS
        RETURN GRADIENTS OF A LAYER.

    GETTERS
    -------
    PARAMETERS(ITEM)
        RETURN PARAMETERS OF A LAYER.
