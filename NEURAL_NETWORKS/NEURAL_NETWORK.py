...
class NEURAL_NETWORK(BASE_ESTIMATOR):
    ...
    def __init__(self, LAYERS, OPTIMIZER, LOSS, MAX_EPOCHS=10, BATCH_SIZE=64, METRIC=MEAN_SQUARED_ERROR, SHUFFLE=False, VERBOSE=True):
        ...
        self.X = None  # THIS LINE OF CODE SETS THE X ATTRIBUTE TO NONE. THIS ATTRIBUTE IS USED TO STORE THE INPUT DATA.
        self.Y = None  # THIS LINE OF CODE SETS THE Y ATTRIBUTE TO NONE. THIS ATTRIBUTE IS USED TO STORE THE TRUE LABELS.
