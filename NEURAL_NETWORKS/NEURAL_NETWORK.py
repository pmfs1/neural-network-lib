...
class NEURAL_NETWORK(BASE_ESTIMATOR):
    ...
    def __init__(self, LAYERS, OPTIMIZER, LOSS, MAX_EPOCHS=10, BATCH_SIZE=64, METRIC=MEAN_SQUARED_ERROR, SHUFFLE=False):
        ...
        # THIS LINE OF CODE SETS THE X ATTRIBUTE TO NONE. THIS ATTRIBUTE IS USED TO STORE THE INPUT DATA.
        self.X = None
        # THIS LINE OF CODE SETS THE Y ATTRIBUTE TO NONE. THIS ATTRIBUTE IS USED TO STORE THE TRUE LABELS.
        self.Y = None
    ...
    def FIT(self, X, Y):
        ...
        self.X = X  # THIS LINE OF CODE SETS THE X ATTRIBUTE TO THE VALUE OF THE X PARAMETER.
        self.Y = Y  # THIS LINE OF CODE SETS THE Y ATTRIBUTE TO THE VALUE OF THE Y PARAMETER.
    ...
    def __SHUFFLE_DATASET__(self):
        ...
        assert self.Y is not None, "Y CANNOT BE NONE"  # THIS LINE OF CODE CHECKS IF THE Y ATTRIBUTE IS NOT NONE.
