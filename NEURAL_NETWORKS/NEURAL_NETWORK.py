...
class NEURAL_NETWORK(BASE_ESTIMATOR):
    ...
    def __init__(self, LAYERS, OPTIMIZER, LOSS, MAX_EPOCHS=10, BATCH_SIZE=64, METRIC=MEAN_SQUARED_ERROR, SHUFFLE=False, VERBOSE=True):
        ...
        super().__init__()
        # THIS LINE OF CODE SETS THE VERBOSE ATTRIBUTE TO THE VALUE OF THE VERBOSE PARAMETER. THIS ATTRIBUTE IS USED TO DETERMINE WHETHER TRAINING PROGRESS SHOULD BE PRINTED TO STDOUT.
    ...
    def __SHUFFLE_DATASET__(self):
        ...
        # THIS LINE OF CODE SHUFFLES THE INDICES VARIABLE.
