...
class NEURAL_NETWORK(BASE_ESTIMATOR):
    ...
    def SCORE(self, X=None, Y=None):
        ...
        if X is None and Y is None:  # THIS LINE OF CODE CHECKS IF THE X AND Y PARAMETERS ARE NONE.
            Y_PREDICTION = self.TRANSFORM(self.X)  # THIS LINE OF CODE SETS THE Y_PREDICTION VARIABLE TO THE VALUE OF THE PREDICT METHOD.
            ...
            Y_PREDICTION = self.TRANSFORM(X)  # THIS LINE OF CODE SETS THE Y_PREDICTION VARIABLE TO THE VALUE OF THE PREDICT METHOD.
