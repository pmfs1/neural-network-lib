...
class GAUSSIAN_NAIVE_BAYES:
    ...
    def __init__(self, VAR_SMOOTHING=1e-9):
        ...
        self.PROBABILITIES = {}
        self.TARGETS = []  # TARGETS: LIST THAT CONTAINS THE TARGETS OF THE DATASET
        self.COLUMNS = []  # COLUMNS: LIST THAT CONTAINS THE COLUMNS OF THE DATASET
