...
class LOCALLY_WEIGHTED_LINEAR_REGRESSION:
    ...
    METHODS
    -------
    __WEIGHT_MATRIX__(POINT, X)
        RETURNS THE WEIGHT MATRIX OF THE LOCALLY WEIGHTED LINEAR REGRESSION MODEL. THE WEIGHT MATRIX IS A DIAGONAL MATRIX WITH THE WEIGHTS OF EACH TRAINING EXAMPLE.
    PREDICT(X)
